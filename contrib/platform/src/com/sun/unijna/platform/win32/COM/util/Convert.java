...
import static com.sun.unijna.platform.win32.Variant.VT_BOOL;
import static com.sun.unijna.platform.win32.Variant.VT_BSTR;
import static com.sun.unijna.platform.win32.Variant.VT_BYREF;
import static com.sun.unijna.platform.win32.Variant.VT_CY;
import static com.sun.unijna.platform.win32.Variant.VT_DATE;
import static com.sun.unijna.platform.win32.Variant.VT_DECIMAL;
import static com.sun.unijna.platform.win32.Variant.VT_DISPATCH;
import static com.sun.unijna.platform.win32.Variant.VT_EMPTY;
import static com.sun.unijna.platform.win32.Variant.VT_ERROR;
import static com.sun.unijna.platform.win32.Variant.VT_I1;
import static com.sun.unijna.platform.win32.Variant.VT_I2;
import static com.sun.unijna.platform.win32.Variant.VT_I4;
import static com.sun.unijna.platform.win32.Variant.VT_I8;
import static com.sun.unijna.platform.win32.Variant.VT_INT;
import static com.sun.unijna.platform.win32.Variant.VT_NULL;
import static com.sun.unijna.platform.win32.Variant.VT_R4;
import static com.sun.unijna.platform.win32.Variant.VT_R8;
import static com.sun.unijna.platform.win32.Variant.VT_RECORD;
import static com.sun.unijna.platform.win32.Variant.VT_UI1;
import static com.sun.unijna.platform.win32.Variant.VT_UI2;
import static com.sun.unijna.platform.win32.Variant.VT_UI4;
import static com.sun.unijna.platform.win32.Variant.VT_UI8;
import static com.sun.unijna.platform.win32.Variant.VT_UINT;
import static com.sun.unijna.platform.win32.Variant.VT_UNKNOWN;
import static com.sun.unijna.platform.win32.Variant.VT_VARIANT;
...
class Convert {
     ...
     * {@link com.sun.unijna.platform.win32.OleAuto#SysFreeString}.</li>
     * </ul>
     *
    ...
    public static VARIANT toVariant(Object value) {
        ...
        } else if (value instanceof com.sun.unijna.platform.win32.COM.Dispatch) {
            return new VARIANT((com.sun.unijna.platform.win32.COM.Dispatch) value);
    ...
    public static Object toJavaObject(VARIANT value, Class<?> targetClass, ObjectFactory factory, boolean addReference, boolean freeValue) {
        ...
        if (targetClass == null || (targetClass.isAssignableFrom(Object.class))) {
            ...
            switch (varType) {
                ...
                case VT_BSTR:
                    ...
                    break;
                case VT_UNKNOWN:
                    targetClass = com.sun.unijna.platform.win32.COM.IUnknown.class;
                    break;
                case VT_DISPATCH:
        ...
        if (Byte.class.equals(targetClass) || byte.class.equals(targetClass)) {
            ...
            if (result instanceof com.sun.unijna.platform.win32.COM.Dispatch) {
                com.sun.unijna.platform.win32.COM.Dispatch d = (com.sun.unijna.platform.win32.COM.Dispatch) result;
