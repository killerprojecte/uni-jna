...
public class COMBindingBaseObject extends COMInvoker {
    ...
    /**
     * @deprecated {@link COMBindingBaseObject#oleMethod(int, com.sun.unijna.platform.win32.Variant.VARIANT.ByReference, java.lang.String, com.sun.unijna.platform.win32.Variant.VARIANT[]) }
     */
    @Deprecated
    protected HRESULT oleMethod(int nType, VARIANT.ByReference pvResult,
    ...
    /**
     * @deprecated {@link COMBindingBaseObject#oleMethod(int, com.sun.unijna.platform.win32.Variant.VARIANT.ByReference, com.sun.unijna.platform.win32.OaIdl.DISPID, com.sun.unijna.platform.win32.Variant.VARIANT[]) }
     */
    @Deprecated
    protected HRESULT oleMethod(int nType, VARIANT.ByReference pvResult,
    ...
    /**
     * @deprecated Use {@link #oleMethod(int, com.sun.unijna.platform.win32.Variant.VARIANT.ByReference, java.lang.String, com.sun.unijna.platform.win32.Variant.VARIANT)}
     */
    @Deprecated
    protected HRESULT oleMethod(int nType, VARIANT.ByReference pvResult,
    ...
    /**
     * @deprecated Use {@link #oleMethod(int, com.sun.unijna.platform.win32.Variant.VARIANT.ByReference, com.sun.unijna.platform.win32.OaIdl.DISPID, com.sun.unijna.platform.win32.Variant.VARIANT)}
     */
    @Deprecated
    protected HRESULT oleMethod(int nType, VARIANT.ByReference pvResult,
    ...
    /**
     * @deprecated Use {@link #oleMethod(int, com.sun.unijna.platform.win32.Variant.VARIANT.ByReference, java.lang.String)}
     */
    @Deprecated
    protected HRESULT oleMethod(int nType, VARIANT.ByReference pvResult,
    ...
    /**
     * @deprecated Use {@link #oleMethod(int, com.sun.unijna.platform.win32.Variant.VARIANT.ByReference, com.sun.unijna.platform.win32.OaIdl.DISPID) }
     */
    @Deprecated
    protected HRESULT oleMethod(int nType, VARIANT.ByReference pvResult,
     ...
     * @param hr
     *            the hr
     * @deprecated Use {@link COMUtils#checkRC(com.sun.unijna.platform.win32.WinNT.HRESULT)}
     */
    @Deprecated
