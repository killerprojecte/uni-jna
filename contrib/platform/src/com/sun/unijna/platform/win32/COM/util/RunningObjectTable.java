...
public class RunningObjectTable implements IRunningObjectTable {
    ...
    protected RunningObjectTable(com.sun.unijna.platform.win32.COM.RunningObjectTable raw, ObjectFactory factory) {
        this.raw = raw;
        this.factory = factory;
    }

    ObjectFactory factory;
    com.sun.unijna.platform.win32.COM.RunningObjectTable raw;
    ...
    public Iterable<IDispatch> enumRunning() {
        ...
        COMUtils.checkRC(hr);
        com.sun.unijna.platform.win32.COM.EnumMoniker raw = new com.sun.unijna.platform.win32.COM.EnumMoniker(
