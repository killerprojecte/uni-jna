...
public class EnumMoniker implements Iterable<IDispatch> {
    ...
    protected EnumMoniker(IEnumMoniker raw, com.sun.unijna.platform.win32.COM.IRunningObjectTable rawRot,
    ...
    ObjectFactory factory;
    com.sun.unijna.platform.win32.COM.IRunningObjectTable rawRot;
    IEnumMoniker raw;
    Moniker rawNext;
