...
import com.sun.unijna.platform.win32.COM.TypeLibUtil.TypeLibDoc;
import com.sun.unijna.platform.win32.OaIdl.MEMBERID;
import com.sun.unijna.platform.win32.OaIdl.TYPEATTR;
import com.sun.unijna.platform.win32.OaIdl.VARDESC;
...
public class TlbInterface extends TlbBase {
     ...
     * (non-Javadoc)
     *
     * @see com.sun.unijna.platform.win32.COM.tlb.imp.TlbBase#getClassTemplate()
     */
    @Override
    protected String getClassTemplate() {
        return "com/sun/unijna/platform/win32/COM/tlb/imp/TlbInterface.template";
    }
}
