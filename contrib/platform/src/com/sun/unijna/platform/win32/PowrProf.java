...
public interface PowrProf extends Library {
    ...
    public interface POWER_INFORMATION_LEVEL {
         ...
         * {@link com.sun.unijna.platform.win32.WinDef.ULONGLONG} that specifies
         ...
         * {@link com.sun.unijna.platform.win32.WinNT.PROCESSOR_POWER_INFORMATION}
         ...
         * <p>
         * The {@code lpOutputBuffer} buffer receives a
         * {@link com.sun.unijna.platform.win32.WinNT.SYSTEM_BATTERY_STATE}
         ...
         * <p>
         * The {@code lpOutputBuffer} buffer receives a
         * {@link com.sun.unijna.platform.win32.WinDef.ULONG} value containing the
         ...
         * <p>
         * The {@code lpOutputBuffer} buffer receives a
         * {@link com.sun.unijna.platform.win32.WinNT.SYSTEM_POWER_CAPABILITIES} structure containing the
         ...
         * <p>
         * The {@code lpOutputBuffer} buffer receives a
         * {@link com.sun.unijna.platform.win32.WinNT.SYSTEM_POWER_INFORMATION} structure.
         * <p>
         ...
         * {@link com.sun.unijna.platform.win32.WinNT.SYSTEM_POWER_POLICY} values
         * passed in {@code lpInBuffer} to the current system power policy used
         * while the system is running on AC (utility) power.
         * <p>
         * The {@code lpOutputBuffer} buffer receives a
         * {@link com.sun.unijna.platform.win32.WinNT.SYSTEM_POWER_POLICY}
         ...
         * <p>
         * The {@code lpOutputBuffer} buffer receives a
         * {@link com.sun.unijna.platform.win32.WinNT.SYSTEM_POWER_POLICY} structure containing the current
