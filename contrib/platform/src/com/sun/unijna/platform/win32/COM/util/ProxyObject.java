...
import com.sun.unijna.internal.ReflectionUtils;
 ...
 */
public class ProxyObject implements InvocationHandler, com.sun.unijna.platform.win32.COM.util.IDispatch,
    ...
    private final com.sun.unijna.platform.win32.COM.IDispatch rawDispatch;
    ...
    private long getUnknownId() {
        ...
        if (-1 == this.unknownId) {
            try {
                ...
                IID iid = com.sun.unijna.platform.win32.COM.IUnknown.IID_IUNKNOWN;
    ...
    @Override
    public com.sun.unijna.platform.win32.COM.IDispatch getRawDispatch() {
    ...
    public Object invoke(final Object proxy, final java.lang.reflect.Method method, final Object[] args)
        ...
        if ((!declaredAsInterface) && (method.getDeclaringClass().equals(Object.class)
                ...
                || method.getDeclaringClass().equals(com.sun.unijna.platform.win32.COM.util.IUnknown.class)
                || method.getDeclaringClass().equals(com.sun.unijna.platform.win32.COM.util.IDispatch.class)
