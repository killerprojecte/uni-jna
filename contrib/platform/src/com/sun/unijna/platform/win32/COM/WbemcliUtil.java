...
import static com.sun.unijna.platform.win32.Variant.VT_VECTOR;
...
import com.sun.unijna.platform.win32.COM.Wbemcli.IWbemLocator;
import com.sun.unijna.platform.win32.COM.Wbemcli.IWbemServices;
...
public class WbemcliUtil {
    ...
    public class WmiResult<T extends Enum<T>> {
         ...
         * {@link com.sun.unijna.platform.win32.Variant} interface.
         *
         * @param property
