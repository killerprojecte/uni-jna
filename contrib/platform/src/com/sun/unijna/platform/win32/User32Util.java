...
import com.sun.unijna.platform.win32.WinDef.HMENU;
import com.sun.unijna.platform.win32.WinDef.HMODULE;
import com.sun.unijna.platform.win32.WinDef.HWND;
import com.sun.unijna.platform.win32.WinDef.LPVOID;
...
public final class User32Util {
    ...
    public static class MessageLoopThread extends Thread {
         ...
         * when the call to {@link com.sun.unijna.platform.win32.User32#GetMessage}
         ...
         * com.sun.unijna.platform.win32.User32Util.MessageLoopThread logger and
        ...
        protected boolean getMessageFailed() {
            ...
            Logger.getLogger("com.sun.unijna.platform.win32.User32Util.MessageLoopThread")
                    .log(Level.WARNING,
