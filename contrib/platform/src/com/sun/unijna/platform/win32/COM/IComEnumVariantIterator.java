...
public class IComEnumVariantIterator implements Iterable<Variant.VARIANT>, Iterator<Variant.VARIANT>, Closeable {
    ...
    /**
     * Helper to get new enumeration from an {@link com.sun.unijna.platform.win32.COM.util.IDispatch}.
     *
     * <p>This expects, that the supplied IDispatch has a property identified by
     * a {@link com.sun.unijna.platform.win32.OaIdl.DISPID} of {@link com.sun.unijna.platform.win32.OaIdl#DISPID_NEWENUM}</p>
     *
     ...
     */
    public static IComEnumVariantIterator wrap(com.sun.unijna.platform.win32.COM.util.IDispatch dispatch) {
