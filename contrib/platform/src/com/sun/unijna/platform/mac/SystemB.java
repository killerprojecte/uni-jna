...
import com.sun.unijna.platform.unix.LibCAPI;
...
public interface SystemB extends LibCAPI, Library {
     ...
     * @param oldlenp
     *            Size of the buffer, a pointer to a {@link com.sun.unijna.platform.unix.LibCAPI.size_t} value
     * @param newp
    ...
    /**
     * @deprecated Use
     *             {@link #sysctl(int[], int, Pointer, com.sun.unijna.platform.unix.LibCAPI.size_t.ByReference, Pointer, com.sun.unijna.platform.unix.LibCAPI.size_t)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Use
     *             {@link #sysctlbyname(String, Pointer, com.sun.unijna.platform.unix.LibCAPI.size_t.ByReference, Pointer, com.sun.unijna.platform.unix.LibCAPI.size_t)}
     */
    @Deprecated
    ...
    /**
     * @deprecated Use {@link #sysctlnametomib(String, Pointer, com.sun.unijna.platform.unix.LibCAPI.size_t.ByReference)}
     */
    @Deprecated
