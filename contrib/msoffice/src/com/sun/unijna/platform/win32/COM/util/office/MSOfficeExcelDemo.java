...
import com.sun.unijna.platform.win32.COM.util.office.excel.ComIAppEvents;
...
public class MSOfficeExcelDemo {
    ...
    public static void testExcel() throws IOException {
        ...
        try {
            ...
            Helper.extractClasspathFileToReal("/com/sun/unijna/platform/win32/COM/util/office/resources/jnatest.xls", demoDocument);
