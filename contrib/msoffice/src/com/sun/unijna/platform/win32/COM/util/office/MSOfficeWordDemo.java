...
import com.sun.unijna.platform.win32.COM.util.office.word.WdOriginalFormat;
import com.sun.unijna.platform.win32.COM.util.office.word.WdSaveFormat;
...
public class MSOfficeWordDemo {
    ...
    public static void testMSWord() throws IOException {
        ...
        try {
            ...
            Helper.extractClasspathFileToReal("/com/sun/unijna/platform/win32/COM/util/office/resources/jnatest.doc", demoDocument);
