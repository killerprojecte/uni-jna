...
import com.sun.unijna.AttachOptions;
import com.sun.unijna.Callback;
import com.sun.unijna.CallbackParameterContext;
import com.sun.unijna.CallbackProxy;
import com.sun.unijna.CallbackReference;
import com.sun.unijna.CallbackReferenceDisposer;
import com.sun.unijna.CallbackResultContext;
import com.sun.unijna.CallbackThreadInitializer;
import com.sun.unijna.DefaultCallbackProxy;
...
import com.sun.unijna.NativeFunctionHandler;
...
import com.sun.unijna.StringArray;
...
import com.sun.unijna.internal.Cleaner;
...
public class CallbackReference extends WeakReference<Callback> implements Closeable {
    ...
    static {
        if (Platform.isWindows()) {
            try {
                DLL_CALLBACK_CLASS = Class.forName("com.sun.unijna.win32.DLLCallback");
    ...
    static Class<?> findCallbackClass(Class<?> type) {
        if (!Callback.class.isAssignableFrom(type)) {
            throw new IllegalArgumentException(type.getName() + " is not derived from com.sun.unijna.Callback");
        }
        if (type.isInterface()) {
            return type;
        }
